...
import type { Pet, SpriteFrame } from '@/features/onlyus/stores/petStore'
import { PET_TYPES, expForLevel } from '@/features/onlyus/stores/petStore'
import SpriteCanvas from '@/shared/ui/SpriteCanvas'
